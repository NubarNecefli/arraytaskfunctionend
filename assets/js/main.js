...
//let ölkəID =common.find(x=>x.id ==id);
//console.log(ölkəID)
...
//function cityfind(city){

//let olketap=common.filter( x=> x.shipAddress.country === city)
...
//let idtap = common.find(x => x.id === id);
...
//let tap = common.find(x => x.id === Id);
//let al = tap.details.length
//console.log(al);
...
//let found= common.find(x=>x.id===ID);
//let all= found.discount.lenght
//console.log(all);
